...
namespace demos
{
    D02ProceduralMeshes::D02ProceduralMeshes()
    {
        ...
        materials[Materials::TexturedPlane].Culling.Enabled = false;
    ...
    void D02ProceduralMeshes::Update()
    {
        ...
        const auto       easing       = std::min(static_cast<float>(static_cast<double>(window::DeltaTime) * FUDGE_FACTOR), 1.0f);
