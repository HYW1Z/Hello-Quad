...
namespace graphics
{
    ...
    void Material::SetMaterialUniform(std::string_view name, float value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::vec2 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::vec3 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::vec4 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, int value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::ivec2 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::ivec3 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::ivec4 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, unsigned value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::uvec2 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::uvec3 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::uvec4 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, bool value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::bvec2 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::bvec3 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::bvec4 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, glm::mat2 value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, const glm::mat3& value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, const glm::mat4& value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, const glm::mat2x3& value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, const glm::mat2x4& value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, const glm::mat3x2& value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, const glm::mat3x4& value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, const glm::mat4x2& value) { setMaterialUniform(name, value); }
    void Material::SetMaterialUniform(std::string_view name, const glm::mat4x3& value) { setMaterialUniform(name, value); }
...
namespace
{
    ...
    graphics::Material::UniformValueType set_uniform(GLenum type, int& sampler_count)
    {
        ...
        switch (type)
        {
            ...
            case GL_FLOAT_MAT2: { uniform = glm::mat2(1.0f); } break;
            case GL_FLOAT_MAT3: { uniform = glm::mat3(1.0f); } break;
            case GL_FLOAT_MAT4: { uniform = glm::mat4(1.0f); } break;
            case GL_FLOAT_MAT2x3: { uniform = glm::mat2x3(1.0f); } break;
            case GL_FLOAT_MAT2x4: { uniform = glm::mat2x4(1.0f); } break;
            case GL_FLOAT_MAT3x2: { uniform = glm::mat3x2(1.0f); } break;
            case GL_FLOAT_MAT3x4: { uniform = glm::mat3x4(1.0f); } break;
            case GL_FLOAT_MAT4x2: { uniform = glm::mat4x2(1.0f); } break;
            case GL_FLOAT_MAT4x3: { uniform = glm::mat4x3(1.0f); } break;
            case GL_SAMPLER_2D:
            case GL_SAMPLER_3D:
